...
<section class="section wrap">
  ...
  <div class="book-grid">
    {% assign other_books = site.books_2a | where_exp: "b", "b.url != featured_book.url" | sort: "date" | reverse %}
...
<section class="section--tight wrap">
  ...
  <div class="talk-cards">
    {% assign recent_writing = site.writing_2a | sort: "date" | reverse %}
  ...
  <div style="text-align:right;margin-top:16px"><a class="section-link" href="{{ '/options/2a/writing-and-talks/' | relative_url }}">See all writing &amp; talks &#8594;</a></div>
</section>
