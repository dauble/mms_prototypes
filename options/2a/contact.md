...
<section class="section--tight wrap" style="max-width:560px">
  <form class="inquiry__form" name="contact-2a" method="POST" data-netlify="true" netlify-honeypot="company" style="background:#fff;border:1px solid var(--border);border-radius:var(--radius-lg);padding:32px">
