...
<section class="section--tight wrap">
  <div class="contact-methods">
    <div class="contact-method">
      ...
      <div class="contact-method__desc">Booking a talk, retreat, or consulting engagement? See the <a class="section-link" href="{{ '/peace-ing-together-consulting/' | relative_url }}">Peace-ing Together Consulting page</a> for programs and the inquiry form.</div>
    </div>
    <div class="contact-method">
...
<section class="section--tight wrap" style="max-width:560px">
  ...
  <form class="inquiry__form" name="contact-2a" method="POST" action="{{ '/api/contact' | relative_url }}" style="background:#fff;border:1px solid var(--border);border-radius:var(--radius-lg);padding:32px">
    ...
    <input type="hidden" name="redirect" value="{{ '/contact/' | relative_url }}">
